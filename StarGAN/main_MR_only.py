...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_epochs', type=int, default=250, help='number of total epochs for training D')
    ...
    parser.add_argument('--train_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/Data/SuperStarGAN/train_mr_only')
    parser.add_argument('--test_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/Data/SuperStarGAN/test_MR')
    parser.add_argument('--validate_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/Data/SuperStarGAN/validation_mr_only')
    parser.add_argument('--validate_case_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/Data/SuperStarGAN/validation_case_mr_only')
    parser.add_argument('--log_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_SuperStarGAN/{new_name}/MR_pretrain/logs')
    parser.add_argument('--model_save_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_SuperStarGAN/{new_name}/models')
    parser.add_argument('--sample_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_SuperStarGAN/{new_name}/MR_pretrain/samples')
    parser.add_argument('--result_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_SuperStarGAN/{new_name}/MR_pretrain/results')
    parser.add_argument('--val_result_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_SuperStarGAN/{new_name}/MR_pretrain/val')
    parser.add_argument('--report_dir', type=str, default=f'/home/chanon/projects/Boo_Thesis/My_SuperStarGAN/{new_name}/MR_pretrain/report')
    ...
    print(config)
    config_txt_path = f"/home/chanon/projects/Boo_Thesis/My_SuperStarGAN/{new_name}/MR_pretrain/config"
